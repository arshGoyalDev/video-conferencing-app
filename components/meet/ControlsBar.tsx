...
const ControlsBar = () => {
  ...
  const [testDevicesTab, setTestDevicesTab] = useState<"video" | "audio" | null>(null);
  ...
  return (
    <>
          ...
          {settingsOpen && (
            <div className="absolute bottom-8 md:bottom-12 left-16 md:-left-10 bg-neutral-900 border-2 border-neutral-800 rounded-lg">
              <div className="flex flex-col text-nowrap">
                ...
                <button
                  onClick={() => {
                    setTestDevicesTab("video");
                    setSettingsOpen(false);
                  }}
                  className="text-left px-5 py-3 border-b-2 border-neutral-800"
                >
                  Test Video
                </button>
                <button
                  onClick={() => {
                    setTestDevicesTab("audio");
                    setSettingsOpen(false);
                  }}
      ...
      {testDevicesTab && (
        <TestDevices
          testDevicesTab={testDevicesTab}
          setTestDevicesTab={setTestDevicesTab}
        />
      )}
    </>
  );
